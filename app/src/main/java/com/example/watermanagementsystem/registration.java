...
public class registration extends AppCompatActivity {
    ...
    private EditText name, nationalId, email, residentialAddress, physicalAddress, contacts, password;
    ...
    private LinearLayout nationalIdLayout, residentialAddressLayout, physicalAddressLayout;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        nationalIdLayout = findViewById (R.id.nationalIdLayout);
        residentialAddressLayout = findViewById (R.id.residentialAddressLayout);
        physicalAddressLayout = findViewById (R.id.physicalAddressLayout);
    ...
    private void updateFormFields (String role) {
        if ( role.equals ("admin") ) {
            nationalIdLayout.setVisibility (View.GONE);
            residentialAddressLayout.setVisibility (View.GONE);
            physicalAddressLayout.setVisibility (View.GONE);
        } else if ( role.equals ("user") ) {
            nationalIdLayout.setVisibility (View.VISIBLE);
            residentialAddressLayout.setVisibility (View.VISIBLE);
            physicalAddressLayout.setVisibility (View.GONE);
        } else if ( role.equals ("waterAuthority") ) {
            nationalIdLayout.setVisibility (View.GONE);
            residentialAddressLayout.setVisibility (View.GONE);
            physicalAddressLayout.setVisibility (View.VISIBLE);
        }
    }
